<template>
		...
		<div class="HUI_Wrap" style="background: #FFFFFF;">
			<div  class="banner">
					<!-- <div class="HUI_SlidePrepare">
						<img src="../assets/img/148223361287.jpg" />
					</div> -->
					<ul>
						<li v-for="item of banner" :key="item._id"><a href="javascript:;"><img :src="baseUrl+item.detail.icon" /></a></li>
					</ul>
			</div>
		</div>
